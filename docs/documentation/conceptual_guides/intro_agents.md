...
## The `smolagents` repository

The `smolagents` repository provides a framework for building agents that use LLMs to perform tasks. The actions performed by LLMs in `smolagents` are defined by the tools and tasks provided to the agents.
